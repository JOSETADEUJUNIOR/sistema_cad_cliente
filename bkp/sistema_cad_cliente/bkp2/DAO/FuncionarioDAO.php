...
class FuncionarioDAO extends Conexao{
    ...
    public function CadastrarFuncionario($nomeFuncionario, $dataAdmissao, $loginFuncionario, $senhaFuncionario, $cargo){
        ...
        $comando_sql = ('Insert into tb_funcionario (nome_funcionario, data_admissao,
                         funcionario_email, funcionario_senha, id_empresa, 
                         id_cargo) values (?,?,?,?,?,?)');
    ...
    public function ConsultarFuncionario(){
        ...
        $conexao = parent::retornaConexao();
        $comando_sql = 'Select id_funcionario, nome_funcionario, data_admissao, data_demissao, funcionario_email, funcionario_senha, 
    ...
    public function MeusDados(){
        ...
        $conexao = parent::retornaConexao();
        $comando_sql = 'Select id_funcionario, nome_funcionario, funcionario_email, funcionario_senha from tb_funcionario where id_funcionario = ? ';
        $sql = $conexao->prepare($comando_sql);
    ...
    public function AlterarDados($id_func, $nome, $login, $senha){
        ...
        $conexao = parent::retornaConexao();
        $comando_sql = 'update tb_funcionario set nome_funcionario = ?, funcionario_email = ?, funcionario_senha = ?
    ...
    public function DetalharFuncionario($id_func){
        ...
        $conexao = parent::retornaConexao();
        $comando_sql = 'Select id_funcionario, nome_funcionario, data_admissao, data_demissao, funcionario_email,
    ...
    public function AlterarFuncionario($nomeFuncionario, $dataAdmissao, $loginFuncionario, $senhaFuncionario, $cargo, $cod){
        ...
        $conexao = parent::retornaConexao();
        $comando_sql = 'update tb_funcionario set nome_funcionario = ?, data_admissao = ?, funcionario_email = ?, funcionario_senha = ?, id_cargo = ? 

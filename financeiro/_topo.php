...
float: right;
font-size: 16px;"> Ultimo Acesso : <?php echo date('d/m/Y'); ?> &nbsp; <a data-toggle="modal" style="background-color: #023e66;" data-target="#Sair" class="btn btn-primary square-btn-adjust">Sair</a>
    </div>
</nav>
